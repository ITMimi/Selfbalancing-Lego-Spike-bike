...
|Der Download-Modus ist der Standardmodus zum ausführen von Programmen. Das Programm wird dabei zunächst auf dem Hub gespeichert und dann ausgeführt. Dadurch kann das Programm auch ausgeführt werden, wenn keine Verbindung zwischen dem Hub und dem Computer besteht. | Im Streaming-Modus werden die Programme in Echtzeit ausgeführt. Dadurch können noch Änderungen an den Programmparametern vorgenommen werden, während das Programm läuft.|
